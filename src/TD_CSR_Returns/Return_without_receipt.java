...
public class Return_without_receipt {
	@Test
	public void return_without_receipt()  throws InterruptedException {
		// TODO Auto-generated method stub
		String Username = "Tmodi";
		String Password = "Password123@";
		String OrderId= "DT1000369757";
//		DT1000369748,DT1000369747,DT1000369742
...
//			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//mat-select[@data-component-id='data-component-id']"))).click();
			...
			driver.findElement(By.xpath("//h4[contains(text(),'NO')]")).click();
			...
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='order-search manh-border-bottom']//input[@id='search-input']"))).sendKeys(Return_OrderID);
			driver.findElement(By.xpath("//div[@class='order-search manh-border-bottom']//manh-icon[@class='mr-4 lookup-icon no-select manh-icon-sm manh-icon manh-icon-search'][normalize-space()='search']")).click();
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'APPROVE RETURN')]"))).click();
			Thread.sleep(9000);
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Reason')]"))).click();
			Thread.sleep(9000);
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),' Manager approval ')]"))).click();
			Thread.sleep(9000);
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),' DONE ')]"))).click();
//			driver.switchTo().window(parentwindow);
//			w.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[data-component-id='orderId']"))).sendKeys(","+Return_OrderID);
//			driver.findElement(By.id("btnApply")).click();
//			w.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[class='datatable-body-cell-label'] input[type='checkbox']"))).click();
//			driver.findElement(By.cssSelector("div[class='button-bar'] a[data-component-id='ViewOrderStatusNextGen']")).click();
//			Thread.sleep(9000);
